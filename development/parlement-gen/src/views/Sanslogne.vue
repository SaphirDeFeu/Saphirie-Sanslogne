...
const parties = ref([
  {'name':"S&D",'seats':4,vote:2,color:'#ff0000'},
  {'name':"PDLS",'seats':20,vote:2,color:'#ff4800'},
  {'name':"Libéraux",'seats':16,vote:2,color:'#ffd800'},
  {'name':"PCG",'seats':2,vote:2,color:'#ff00dc'},
  {'name':"Démocrates-Théocrates",'seats':20,vote:2,color:'#0094ff'},
]);
